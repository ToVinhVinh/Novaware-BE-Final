...
class OrderViewSet(viewsets.ViewSet):
    ...
    def pay(self, request, pk=None):
        ...
        order.payment_result = request.data.get("payment_result", order.payment_result)
        order.mark_paid()
    ...
    @action(detail=True, methods=["post", "put"], url_path="deliver", permission_classes=[permissions.AllowAny], authentication_classes=[])
